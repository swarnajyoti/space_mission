function M = radiantEmittance(T)
%
% This fucntion computes the RADIANT EMITTANCE of a black body at a given
% temperature T under the Lambertian source assumption. This is the
